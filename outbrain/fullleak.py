...
df_test = pd.read_csv(data_path+'clicks_test.csv')
df_ad = pd.read_csv(data_path+'promoted_content.csv',
...
f = open("data/page_views_sample.csv", "r")
...
train = pd.read_csv(data_path+"clicks_train.csv")
