# Source : https://www.kaggle.com/jiweiliu/outbrain-click-prediction/extract-leak-in-30-mins-with-small-memory/code
...
filename = 'data/page_views_sample.csv' # comment this out locally
